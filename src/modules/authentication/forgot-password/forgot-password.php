...
<body>
    ...
    <div class="bg-cover bg-center md:overflow-hidden h-screen w-screen flex flex-col px-5"
        ...
        <div class="flex-grow bg-white m-4 rounded-xl flex md:flex-row flex-col bg-opacity-25 shadow-2xl"
            style="backdrop-filter: blur(8px);">
            <div class="bg-gray-900 md:rounded-l-xl rounded-t-xl md:w-1/3 w-full md:h-full h-1/3 overflow-hidden">
                ...
                <form action="send-reset-link.php" method="post" class="w-full py-6 px-2">
                    ...
                    <div class="flex flex-row justify-end pt-11">
                        <input type="submit" name="submit" id="submit"
                            class="md:w-1/5 text-center p-5 h-full rounded-xl bg-slate-200 hover:bg-lime-100 active:bg-lime-200  active:shadow-inner font-semibold transition transform duration-500 hover:scale-110 focus:outline-none" />
                    </div>
                </form>
            </div>
        </div>
