            ...
            <div class="h-screen w-screen py-11 px-52">
                <div class="bg-gray-200 bg-opacity-25 bg-blur rounded-xl flex flex-row h-full w-full "
                    ...
                    <div class="bg-gray-900 rounded-l-xl w-1/3 h-full overflow-hidden">
                        <img src="../../images/otp/otp.gif" alt=""
                            ...
                            <form action="verify-otp-process.php" method="POST" class="w-full py-6 px-2">
                                ...
                                <div class="flex space-x-4">
                                    <input type="text" name="digit1"
                                        class="w-20 h-16 focus:outline-none text-center border rounded-lg rounded-l-full otp-input"
                                        maxlength="1">
                                    <input type="text" name="digit2"
                                        class="w-20 h-16 focus:outline-none text-center border rounded-lg otp-input"
                                        maxlength="1">
                                    ...
                                    <input type="text" name="digit6"
                                        class="w-20 h-16 focus:outline-none text-center border rounded-lg rounded-r-full otp-input"
                                        maxlength="1">
                                </div>

                                <div class="flex flex-row justify-end pt-8">
                                    <button id="sbmitbtn" type="submit"
                                        class=" p-5 rounded-xl font-semibold transition transform duration-500 hover:scale-110  bg-slate-200 hover:bg-lime-100 active:bg-lime-200">Verify
                                        OTP</button>
                                </div>
                            </form>
                        </div>
