  ...
  <div class="bg-cover bg-center md:overflow-hidden h-full md:h-screen w-screen flex flex-col md:px-5" style="background-image: url('../../images/dashboard/background.jpg');">
    ...
    <div class="flex-grow bg-white m-4 rounded-xl rounded-t-xl flex flex-col md:flex-row bg-opacity-25 shadow-xl" style="backdrop-filter: blur(8px);">
      <div class="bg-gray-900 md:rounded-l-xl rounded-t-xl w-full h-1/3 md:w-1/3 md:h-full overflow-hidden">
        <img src="../../images/login/hero-gif.gif" alt="" class="hidden md:block object-cover md:rounded-l-xl shadow-xl h-full w-full object-center transition transform duration-500 hover:scale-110  ">
      ...
      <div class="flex-grow rounded-r-xl md:ml-5 p-5 flex flex-col justify-center items-center">
        <form action="login.php" method="post" class="w-full py-2 md:py-6 px-2">
          ...
          <div class="pt-2">
            ...
            <input type="email" name="email" id="email" class="w-full rounded-2xl shadow-xl bg-white opacity-50 p-5  focus:outline-none">
          </div>
          <div class="pt-2">
            <label for="password" class="text-white text-lg font-semibold shadow-xl pl-2">Password</label>
            <input type="password" name="password" id="pass" class="w-full rounded-2xl shadow-xl bg-white opacity-50 p-5  focus:outline-none">
          </div>
          <div class="flex flex-col md:flex-row pt-6 items-center justify-center md:justify-start space-y-4 md:space-y-0 md:space-x-6">
