                        ...
                        <div class="space-y-1 p-5 flex flex-col justify-center items-center h-full">
                            <form action="#" class="w-full py-6 px-2">
                                ...
                                <div class="flex flex-row justify-end pt-7">
                                    <a href="#"
                                        class="w-1/5 text-center p-5 h-full rounded-xl bg-slate-200 hover:bg-slate-400 active:bg-slate-500 active:text-gray-50 active:shadow-inner font-semibold transition transform duration-500 hover:scale-110">Next</a>
                                </div>
                            </form>
